...
with open("MainCH.tsv") as tsvfile:
    ...
    print(cardSetID)
#{"__v":0,"name":"BasePack","_id":"58e875b83bbe73001117c65e","cards":[]}
    for p in cardSet:                           #iterate through all cards
        ...
        #{"__v":0,"text":"______ + ______ = ______.","draw":2,"pick":3,"type":"black","vendor":"official","_id":"58e87f203264620011f56f27"}
